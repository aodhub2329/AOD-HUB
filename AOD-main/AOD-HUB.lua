...
if Third_Sea then
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = "Auto Fish",Description = "", Default = false })
...
spawn(function()
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Auto Eliter",Description = "", Default = false })
