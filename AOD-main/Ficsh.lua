...
local Tabs = {
    ...
    Premium = Window:AddTab({ Title = "Cast Zone", Icon = "diamond" }),
...
do
    ...
    local DropdownArea = Tabs.Teleports:AddDropdown("DropdownArea", {
        ...
        Values = {"Roslit_Bay", "Ocean", "Snowcap_Pond", "Moosewood_Docks", "Deep_Ocean", "Vertigo", "Snowcap_Ocean", "Harvesters_Spike", "SunStone", "Roslit_Bay_Ocean", "Moosewood_Pond", "Terrapin_Ocean", "Isonade", "Moosewood_Ocean", "Roslit_Pond", "Moosewood_Ocean_Mythical", "Terrapin_Olm", "The_Arch", "Scallop_Ocean", "SunStone_Hidden", "Mushgrove_Stone", "Keepers_Altar", "Lava", "Roslit_Pond_Seaweed", "Depths_Fishing_Spot", "Depths_Event_Spot"},
        Multi = false,
    })
